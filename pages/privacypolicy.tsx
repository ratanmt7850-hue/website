  ...
  return (
    <div className="bg-gray-900 max-w-[1600px] mx-auto text-white py-10 px-4">
      <div className="text-center py-2">
        <h1 className="text-xxl font-bold">Privacy Policy</h1>
      </div>
      {data.webtoggle ? (
        <div className="space-y-10 px-4 text-justify">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-2">
              ...
              <li>
                ...
                Company,&quot; &quot;We,&quot; &quot;Us,&quot; or
                &quot;Our&quot; in this Agreement, refers to RATAN MATKA.
              </li>
              <li>
              ...
              <li>
                <strong>Third-party Social Media Service:</strong> Any website
                or social network website through which a user can log in or
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-2">
              ...
              <li>
                ...
                Persistent Cookies that identify if users have accepted the use
                of cookies.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-2">
              ...
              <li>
                To contact you with updates, offers, and other information.
              </li>
              <li>To manage your requests.</li>
              <li>For business transfers.</li>
              <li>
                For other purposes such as data analysis and service
                improvement.
              </li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              for the purposes set out in this Privacy Policy. We will also
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              your Personal Data. You may update, amend, or delete your
              information by signing in to your account or contacting us.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              circumstances, including business transactions, legal
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              you are a parent or guardian aware that your child has provided us
        ...
        <div className="space-y-10 px-4 text-justify">
          <section>
            ...
            <p className="mt-4">
              At RATAN MATKA, your privacy is our priority. This Privacy Policy
              outlines how we collect, use, and protect your personal
              information when you use our quiz game services. By accessing or
              using our services, you agree to this Privacy Policy&apos;s terms.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mt-4">Interpretation</h3>
            <p className="mt-2">
              Words with initial capital letters have specific meanings defined
            ...
            <ul className="list-disc list-inside mt-2 space-y-2">
              ...
              <li>
                <strong>Service:</strong> Refers to the quiz game website.
              </li>
              <li>
                <strong>Service Provider:</strong> Any natural or legal person
                who processes data on behalf of the Company.
              ...
              <li>
                <strong>Website:</strong> Refers to RATAN MATKA , accessible
                from [Website].
              </li>
              <li>
                <strong>You:</strong> The individual accessing or using the
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              to protect your personal information. We employ industry-standard
              practices and technologies to ensure your data is safe and secure
              at all times.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              We may update our Privacy Policy occasionally and notify you of
